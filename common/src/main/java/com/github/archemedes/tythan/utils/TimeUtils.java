...
public final class TimeUtils {
    public static @Nullable Instant parseEager(String input) {
    ...
    public static @Nullable LocalDateTime tryParseTime(String input) {
        try {
    ...
    public static @Nullable LocalDateTime tryParseDate(String input) {
        try {
    ...
    public static @Nullable LocalDateTime tryParseDateTime(String input) {
        try {
    ...
    public static @Nullable Duration parseDuration(String parsable) {
    ...
    public static Component printMillis(long millis) {
        return print(millis, false, TColor.WHITE, TColor.GRAY);
    }
    ...
    public static Component print(long ms, boolean brief, TColor numColor, TColor unitColor) {
        var sb = new CommonKyoriComponentBuilder();

        if(ms > 10L * 365 * 24 * 3600 * 1000) {
            sb.append("unknown");
    ...
    private static boolean append(AbstractKyoriComponentBuilder<?> sb, long val, boolean brief, String big, String small, TColor c1, TColor c2, boolean space) {
