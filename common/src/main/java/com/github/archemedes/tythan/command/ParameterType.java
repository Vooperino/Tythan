...
public class ParameterType<T> {
    ...
    public final void register() {
        ...
        if(existing != null) {
            Tythan.get().getLogger().warning("Attempted a merge on a custom command argument type for the class: " + forClass.getSimpleName());
            Tythan.get().getLogger().warning("This might be fine but more likely this was unintended and might lead to unexpected behavior");
    ...
    public void settle(CommandArgument<T> arg) {
