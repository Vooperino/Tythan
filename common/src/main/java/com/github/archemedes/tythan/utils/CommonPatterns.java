...
public class CommonPatterns {
    ...
    @NotNull public final static Pattern HEX_COLOR = Pattern.compile("^#[0-9a-f]{3}([0-9a-f]{3})?$");
    @NotNull public final static Pattern HEX_COLOR_NOSH = Pattern.compile("^[0-9a-f]{3}([0-9a-f]{3})?$");
    @NotNull public final static Pattern RGB_COLOR = Pattern.compile("^rgb\\(\\s*(0|[1-9]\\d?|1\\d\\d?|2[0-4]\\d|25[0-5])%?\\s*,\\s*(0|[1-9]\\d?|1\\d\\d?|2[0-4]\\d|25[0-5])%?\\s*,\\s*(0|[1-9]\\d?|1\\d\\d?|2[0-4]\\d|25[0-5])%?\\s*\\)$");
    @NotNull public final static Pattern RGBA_COLOR = Pattern.compile("^rgba\\(\\s*(0|[1-9]\\d?|1\\d\\d?|2[0-4]\\d|25[0-5])%?\\s*,\\s*(0|[1-9]\\d?|1\\d\\d?|2[0-4]\\d|25[0-5])%?\\s*,\\s*(0|[1-9]\\d?|1\\d\\d?|2[0-4]\\d|25[0-5])%?\\s*,\\s*((0.[1-9])|[01])\\s*\\)$");
    @NotNull public final static Pattern HSL_COLOR = Pattern.compile("^hsl\\(\\s*(0|[1-9]\\d?|[12]\\d\\d|3[0-5]\\d)\\s*,\\s*((0|[1-9]\\d?|100)%)\\s*,\\s*((0|[1-9]\\d?|100)%)\\s*\\)$");
    ...
    public static @NotNull String concatGroups(@NotNull Matcher matcher) {
    ...
    public static @NotNull String digitsAndPlusOnly(@NotNull Matcher matcher) {
